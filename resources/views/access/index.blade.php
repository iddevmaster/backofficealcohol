      ...
      <div class="relative z-50 w-full max-w-3xl bg-white rounded-xl shadow-lg">
        ...
        <form method="post" action="{{ route('admin.roles.store') }}">
          ...
          <div class="p-4 grid grid-cols-1 md:grid-cols-3 gap-4">
            <div class="space-y-3">
              <div><label class="block text-sm mb-1">Name *</label><input name="name" required
              ...
              <div class="pt-2">
                ...
                <button type="button" @click="toggleAllPerms(false)"
                  class="text-slate-700 text-sm underline">Uncheck</button>
              </div>
            </div>
            <div class="md:col-span-2">
              <label class="block text-sm mb-2">Permissions</label>
              <div
                class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-2 max-h-80 overflow-auto p-2 border rounded">
                @foreach($permissions as $p)
