        ...
        <div class="card p-8 shadow-xl border-0">
            ...
            <form class="space-y-6" method="POST" action="{{ route('login') }}">
                ...
                <div>
                    ...
                    <div class="relative">
                        <input type="text" id="username" name="username" class="input-field pl-10 pr-4"
                            placeholder="กรอกชื่อของคุณ" required autofocus />
...
@error('username') <div class="text-red-600 text-sm">{{ $message }}</div> @enderror -->
                ...
                <div>
                    ...
                    <div class="relative">
                        <input type="password" id="password" name="password" class="input-field pl-10 pr-12"
                        ...
                        <button type="button" id="togglePassword"
                            ...
                            <svg id="eyeIcon" class="h-5 w-5 text-slate-400 hover:text-slate-600" fill="none"
                ...
                <div class="flex items-center justify-between">
                    <div class="flex items-center">
                        <input id="remember" name="remember" type="checkbox"
                            class="h-4 w-4 text-primary focus:ring-primary-500 border-slate-300 rounded" />
                    ...
                    <div class="text-sm">
                        <a href="javascript:void(0)"
                            class="font-medium text-primary hover:text-primary-700 transition-colors duration-150">
                            ลืมรหัสผ่าน?
                        </a>
                    </div>
                </div>
                ...
                <div>
                    <button type="submit" id="loginButton"
                        class="w-full btn-primary py-3 text-base font-medium relative overflow-hidden">
            ...
            <div class="mt-8 p-4 bg-slate-50 rounded-lg border border-slate-200">
                ...
                <div class="space-y-1 text-xs text-slate-600">
                    <p><strong>Admin:</strong> superadmin / 12345678</p>
