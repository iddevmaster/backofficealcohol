            ...
            <form method="GET" action="{{ route('report.report') }}">
                <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-5 gap-4">
                    ...
                    <div>
                        ...
                        <select name="result_status"
                            class="w-full rounded-xl border-slate-300 focus:border-indigo-500 focus:ring-indigo-500">
                            <option value="">ทั้งหมด</option>
                            <option value="pass" {{ request('result_status') == 'pass' ? 'selected' : '' }}>ผ่าน
                            </option>
                            <option value="fail" {{ request('result_status') == 'fail' ? 'selected' : '' }}>ไม่ผ่าน
                            </option>
                        </select>
                    </div>
                </div>
                ...
                <div class="mt-4 flex flex-wrap gap-2">
                    ...
                    <a href="{{ route('report.alcohol.export', request()->query()) }}"
                        class="inline-flex items-center justify-center px-4 py-2 rounded-xl bg-emerald-600 hover:bg-emerald-700 text-white text-sm font-semibold shadow-sm gap-2">
                    ...
                    <a href="{{ route('report.alcohol.pdf', request()->query()) }}"
                        class="inline-flex items-center justify-center px-4 py-2 rounded-xl bg-rose-600 hover:bg-rose-700 text-white text-sm font-semibold shadow-sm gap-2">
                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 10v6m0 0l-3-3m3 3l3-3m2 8H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"></path>
                        </svg>
                        Export PDF
