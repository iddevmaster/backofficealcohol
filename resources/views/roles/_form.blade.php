...
$selected = old('permissions', $selected ?? ($role->permissions->pluck('id')->toArray() ?? [])); @endphp
...
<div class="mt-4">
  ...
  <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-2 max-h-[80vh] overflow-auto p-2 border rounded">
