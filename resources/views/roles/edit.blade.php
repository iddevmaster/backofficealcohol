...
<form method="post" action="{{ route('admin.roles.update',$role) }}" class="bg-white rounded-xl shadow p-4 space-y-4">
  @csrf @method('PUT')
  ...
  <div class="flex gap-2">
    ...
    <a href="{{ route('admin.roles.index') }}" class="rounded bg-gray-200 px-4 py-2">ยกเลิก</a>
  </div>
</form>
</x-app-layout>
