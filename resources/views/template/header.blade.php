        ...
        <div class="flex items-center justify-between px-4 py-3">
            ...
            <div class="flex items-center space-x-4">
                <button id="sidebarToggle"
                    class="p-2 rounded-md hover:bg-secondary-100 focus:outline-none focus:ring-2 focus:ring-primary-500 lg:hidden">
            ...
            <div class="flex items-center space-x-4">
                ...
                <div class="relative">
                    <button id="userMenuButton"
                        ...
                        <img src="https://ui-avatars.com/api/?name={{ urlencode(Auth::user()->first_name ?: Auth::user()->username) }}&color=7F9CF5&background=EBF4FF"
                        ...
                        <div class="hidden md:block text-left">
                            <p class="text-sm font-medium text-secondary-800" id="userName">{{ Auth::user()->first_name ? Auth::user()->first_name . ' ' . Auth::user()->last_name : Auth::user()->username }}</p>
                            <p class="text-xs text-secondary-500" id="userRole">{{ Auth::user()->role?->name ?? 'User' }}</p>
                        </div>
                    ...
                    <!-- Dropdown Menu -->
                    <div id="userDropdown"
                        class="hidden absolute right-0 mt-2 w-48 bg-white rounded-md shadow-lg border border-secondary-200 z-50">
                        <div class="py-1">
