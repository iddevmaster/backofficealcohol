<aside id="sidebar"
    ...
    <nav class="p-4 space-y-2">
        ...
        <div class="space-y-1 mb-4">
            ...
            @endcan
            @can('list anonymous-tests')
                <a href="{{ url('anonymous-tests') }}"
                class="flex items-center space-x-3 px-3 py-2 rounded-md text-secondary-600 hover:bg-secondary-50 hover:text-secondary-900 transition-colors">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
                </svg>
                <span>Anonymous Tests</span>
            </a>
            @endcan
            @can('list histories')
                <a href="{{ url('device-scans') }}"
                class="flex items-center space-x-3 px-3 py-2 rounded-md text-secondary-600 hover:bg-secondary-50 hover:text-secondary-900 transition-colors">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
        ...
        {{-- Master Data --}}
        @if (auth()->user()->hasAnyPermission(['list employees', 'list finger', 'show organizations', 'list org_devices']))
            <div class="space-y-1 mb-4">
                ...
                @endcan
                @can('list org_devices')
                    <a href="{{ url('admin/org-devices') }}"
                        class="flex items-center space-x-3 px-3 py-2 rounded-md text-secondary-600 hover:bg-secondary-50 hover:text-secondary-900 transition-colors">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                d="M19 11H5m14 0a2 2 0 012 2v6a2 2 0 01-2 2H5a2 2 0 01-2-2v-6a2 2 0 012-2m14 0V9a2 2 0 00-2-2M5 11V9a2 2 0 012-2m0 0V5a2 2 0 012-2h6a2 2 0 012 2v2M7 7h10" />
                        </svg>
                        <span>Org Devices</span>
                    </a>
                @endcan
        ...
        {{-- Admin --}}
        @if (auth()->user()->hasAnyPermission(['list organizations', 'list branches', 'list departments', 'list roles', 'list users']))
            <div class="space-y-1 mb-4">
